...
class OpenAIGateway:
    ...
    def guard_query(
        ...
        prompt = (
            ...
            " - Use needs_context only when the latest input cannot be judged alone because it is a short elliptical follow-up, confirmation, refusal, or reply to a previous assistant question. Examples: \"yes\", \"no\", \"ok\", \"how\", \"then\", \"details\", \"send it\", \"documents\", \"what docs\", \"General\", \"What about student\", or \"So am I\" without context.\n"
            " - Do not use needs_context for complete questions, standalone supported topic phrases, standalone unsupported task requests, or clearly unsafe requests. Decide these immediately in the first pass.\n"
            ...
            " - Do not request context for standalone in-scope messages like \"How to get DSU\", \"DSU\", \"How to apply to uni\", \"visa\", \"виза\", \"visa docs\", \"How to apply for visa\", \"How do I get visa?\", \"visa application\", \"ВНЖ\", \"residence permit\", \"How do I get residence permit\", \"How do I get a residence permit\", \"How do I renew residence permit\", \"residence permit documents\", \"How to apply for residence permit…\", \"How can I apply for residence permit in Italy?\", \"Как оформить ВНЖ\", \"Как получить ВНЖ\", \"тұруға рұқсат\", \"тұруға ықтиярхатты қалай аламын\", or \"тұруға рұқсатты қалай алуға болады\".\n"
            " - Do not request context for standalone out-of-scope messages like \"Book me a hotel in Rome\", \"Find cheap flights to Milan\", \"Can you plan my Rome vacation?\", or \"How can I get a work visa in Italy?\". These are out_of_scope, not needs_context.\n"
            ...
            " - If the user says \"visa\" without saying tourist, work, business, family, travel, or another non-study context, assume Italian student visa by default. Short phrases like \"visa\", \"visa docs\", \"How to apply for visa\", \"How do I get visa?\", \"visa application\", or \"student visa documents Italy\" are standalone and allowed. Do not let unrelated or weak previous assistant answers turn a standalone student-visa-default query into out_of_scope.\n"
            " - If the user mentions DSU without another explicit meaning, allow it as the Italian DSU student scholarship/financial aid. A bare \"DSU\" is standalone enough to pass.\n"
            " - If the user asks about ISEE, equivalent ISEE, what ISEE is needed, studying for free, tuition waiver, or scholarship/free-study financial eligibility, allow it as an in-scope education-finance question.\n"
            ...
            '{"allowed":true,"needs_context":false,"violation":"","reason":"DSU defaults to the Italian student scholarship topic.","language":"en"} for input like "DSU"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"ISEE eligibility for scholarships or tuition waiver is in scope.","language":"ru"} for input like "Какой isee нужен для учебы бесплатно"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Equivalent ISEE questions are in scope.","language":"en"} for input like "What ISEE is needed to study for free?"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Bare visa defaults to the Italian student visa topic.","language":"ru"} for input like "виза"\n'
            ...
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Visa application defaults to the Italian student visa topic.","language":"en"} for input like "How to apply for visa"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Visa questions default to the Italian student visa topic.","language":"en"} for input like "How do I get visa?"\n'
            ...
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Bare residence permit defaults to the Italian student residence permit topic.","language":"en"} for input like "residence permit"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Residence permit renewal defaults to the Italian student residence permit topic.","language":"en"} for input like "How do I renew residence permit"\n'
            ...
            '{"allowed":true,"needs_context":false,"violation":"","reason":"ВНЖ defaults to the student residence permit topic.","language":"ru"} for input like "ВНЖ"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"ВНЖ application defaults to the student residence permit topic.","language":"ru"} for input like "Как оформить внж"\n'
            ...
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Kazakh residence permit wording defaults to the Italian student residence permit topic.","language":"kk"} for input like "тұруға рұқсат"\n'
            '{"allowed":true,"needs_context":false,"violation":"","reason":"Kazakh residence permit wording defaults to the Italian student residence permit topic.","language":"kk"} for input like "тұруға ықтиярхатты қалай аламын"\n'
            ...
            '{"allowed":false,"needs_context":false,"violation":"out_of_scope","reason":"Hotel booking is outside the education-abroad scope.","language":"en"} for input like "Book me a hotel in Rome"\n'
            '{"allowed":false,"needs_context":false,"violation":"out_of_scope","reason":"Flight search is outside the education-abroad scope.","language":"en"} for input like "Find cheap flights to Milan"\n'
            '{"allowed":false,"needs_context":false,"violation":"out_of_scope","reason":"Vacation planning is outside the education-abroad scope.","language":"en"} for input like "Can you plan my Rome vacation?"\n'
            '{"allowed":false,"needs_context":false,"violation":"out_of_scope","reason":"Work visas are outside the study-abroad scope.","language":"en"} for input like "How can I get a work visa in Italy?"\n'
        ...
        try:
            ...
            if history_block and self._json_bool(parsed.get("needs_context"), default=False):
                repair_prompt = (
                    ...
                    "If the latest input is standalone in-scope by itself, such as a bare student-visa-default or residence-permit-default query, set allowed=true even if previous assistant messages were refusals or weak-retrieval fallbacks. "
    ...
    def classify_query(
        ...
        prompt = (
            ...
            "Examples that should go to RAG_SEARCH include \"visa\", \"How to apply for visa\", \"How do I get visa?\", \"visa application\", \"visa docs\", \"How do I get residence permit\", \"How to apply for residence permit…\", \"residence permit\", \"residence permit documents\", \"Docs required\" after a residence-permit topic, \"residence permit in Italy\", \"Compare Italy and Germany for master studies\", \"Как получить ВНЖ\", \"Как подать на студ ВНЖ\", \"студ внж процесс\", and \"тұруға рұқсатты қалай алуға болады\". "
            "Bare visa queries default to Italian student visa and should be PROCEDURE or FACTUAL_QUESTION with RAG_SEARCH unless the user explicitly says tourist, work, business, family, travel, permanent, asylum, or another non-study context. "
            ...
            "{\"intent\":\"PROCEDURE\",\"confidence\":0.88,\"needs_rag\":true,\"route\":\"RAG_SEARCH\",\"reason\":\"User asks how to apply for an Italian student visa by default.\",\"rewritten_query\":\"how to apply for Italian student visa\",\"language\":\"en\",\"profile_action\":\"\",\"preferred_name\":\"\"} for input like \"How to apply for visa\"\n"
            "{\"intent\":\"PROCEDURE\",\"confidence\":0.88,\"needs_rag\":true,\"route\":\"RAG_SEARCH\",\"reason\":\"User asks how to get an Italian student visa by default.\",\"rewritten_query\":\"how to apply for Italian student visa\",\"language\":\"en\",\"profile_action\":\"\",\"preferred_name\":\"\"} for input like \"How do I get visa?\"\n"
    ...
    def clarify_or_rewrite_query(
        ...
        prompt = (
            ...
            " - A visa question without explicit tourist, work, business, family, travel, permanent, asylum, or another non-study context defaults to Italian student/study/enrollment visa. Do NOT ask whether the user means student visa for bare visa queries.\n"
            ...
            "For a generic visa query without explicit non-study context, assume Italian student visa and produce a complete standalone query.\n"
            ...
            '{"is_retrieval_related":true,"is_clear":true,"standalone_query":"How to apply for an Italian student visa?","clarifying_question":"","target_language":"","reason":"Bare visa application defaults to the Italian student visa topic."}\n'
            '{"is_retrieval_related":true,"is_clear":true,"standalone_query":"How to apply for an Italian student visa?","clarifying_question":"","target_language":"","reason":"How do I get visa defaults to the Italian student visa topic."}\n'
