...
class OpenAIGateway:
    ...
    def classify_query(
        ...
        prompt = (
            ...
            "Examples that should go to RAG_SEARCH include \"visa docs\", \"residence permit in Italy\", \"Compare Italy and Germany for master studies\", \"Как подать на студ ВНЖ\", and \"студ внж процесс\". "
    ...
    def clarify_or_rewrite_query(
        ...
        prompt = (
            ...
            "\"how to apply to uni\", \"how to get dsu\", \"dsu money\", \"visa docs\", \"residence permit in Italy\", \"Как получить внж\", \"permesso di soggiorno\", \"can I travel while studying\", \"Италияда оқып жүріп саяхаттай аламын ба\", \"cv help\", \"scholarship money\", \"motivation letter structure\", \"recommendation letter who\".\n"
            ...
            " - \"residence permit in Italy\", \"student residence permit\", \"студ ВНЖ\", \"как подать на студ ВНЖ\", and \"permesso di soggiorno\" are clear Italian student residence permit queries. For broad versions, use a standalone query covering process and required documents instead of asking process-vs-documents.\n"
