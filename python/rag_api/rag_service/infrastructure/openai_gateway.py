...
class OpenAIGateway:
    ...
    def guard_query(
        ...
        prompt = (
            ...
            " - Do not request context for standalone messages like \"How to get DSU\", \"How to apply to uni\", \"visa docs\", \"How do I get residence permit\", \"residence permit documents\", \"How can I apply for residence permit in Italy?\", \"Как получить ВНЖ\", or clearly unsafe/out-of-scope requests.\n"
    ...
    def classify_query(
        ...
        prompt = (
            ...
            "Examples that should go to RAG_SEARCH include \"visa docs\", \"How do I get residence permit\", \"residence permit\", \"residence permit documents\", \"residence permit in Italy\", \"Compare Italy and Germany for master studies\", \"Как подать на студ ВНЖ\", and \"студ внж процесс\". "
            "Bare residence-permit queries default to Italian student residence permit and should be PROCEDURE or FACTUAL_QUESTION with RAG_SEARCH, not OUT_OF_DOMAIN or CLARIFY, unless the user explicitly says work, tourist, family, permanent residence, asylum, or another non-study context. "
    ...
    def clarify_or_rewrite_query(
        ...
        prompt = (
            ...
            " - A residence permit, ВНЖ/внж, VNJ, or permesso di soggiorno question is in scope by default as an Italian student residence permit unless the user explicitly says work, tourist, family, permanent residence, asylum, or another non-study context. Do NOT ask whether the user means visa or residence permit when they say ВНЖ/внж; that term is already a residence-permit topic.\n"
            ...
            "\"how to apply to uni\", \"how to get dsu\", \"dsu money\", \"visa docs\", \"How do I get residence permit\", \"residence permit\", \"residence permit documents\", \"residence permit in Italy\", \"Как получить внж\", \"permesso di soggiorno\", \"can I travel while studying\", \"Италияда оқып жүріп саяхаттай аламын ба\", \"cv help\", \"scholarship money\", \"motivation letter structure\", \"recommendation letter who\".\n"
            ...
            " - \"How do I get residence permit\", \"residence permit\", \"residence permit documents\", \"residence permit in Italy\", \"student residence permit\", \"студ ВНЖ\", \"как подать на студ ВНЖ\", and \"permesso di soggiorno\" are clear Italian student residence permit queries. For broad versions, use a standalone query covering process and required documents instead of asking process-vs-documents.\n"
