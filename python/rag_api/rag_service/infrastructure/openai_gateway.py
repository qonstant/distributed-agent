...
class OpenAIGateway:
    ...
    def guard_query(
        ...
        prompt = (
            ...
            " - Do not request context for standalone messages like \"How to get DSU\", \"How to apply to uni\", \"visa docs\", \"How do I get residence permit\", \"residence permit documents\", \"How to apply for residence permit…\", \"How can I apply for residence permit in Italy?\", \"Как получить ВНЖ\", or clearly unsafe/out-of-scope requests.\n"
    ...
    def assess_retrieval_sufficiency(
        ...
        prompt = (
            ...
            " - For residence permit, permesso di soggiorno, or ВНЖ queries without explicit work/tourist/family/permanent/asylum context, the intended topic is Italian student residence permit. NEVER ask whether the user means student residence permit specifically or general residence permit information.\n"
